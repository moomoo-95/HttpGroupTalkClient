...
public class HgtpBadRequestResponse extends HgtpMessage {

    private final HgtpHeader hgtpHeader;

    public HgtpBadRequestResponse(byte[] data) throws HgtpException {
    ...
    public HgtpBadRequestResponse(Short requestType, String userId, int seqNumber) {
        this.hgtpHeader = new HgtpHeader(AppInstance.MAGIC_COOKIE, HgtpMessageType.BAD_REQUEST, requestType, userId, seqNumber, AppInstance.getInstance().getTimeStamp(), 0);
    }
