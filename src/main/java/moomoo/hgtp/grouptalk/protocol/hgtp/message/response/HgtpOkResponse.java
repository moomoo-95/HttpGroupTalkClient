...
public class HgtpOkResponse extends HgtpMessage {

    private final HgtpHeader hgtpHeader;

    public HgtpOkResponse(byte[] data) throws HgtpException {
    ...
    public HgtpOkResponse(Short requestType, String userId, int seqNumber) {
        this.hgtpHeader = new HgtpHeader(AppInstance.MAGIC_COOKIE, HgtpMessageType.OK, requestType, userId, seqNumber, AppInstance.getInstance().getTimeStamp(), 0);
    }
